...
def runserver():
    ...
    # mysql://{CONF.mysql.user}:{CONF.mysql.password}@{CONF.mysql.host}:{CONF.mysql.port}/{CONF.mysql.database}?charset=utf8
    # mysql_url = f'mysql+pymysql://{CONF.mysql.user}:{CONF.mysql.password}@{CONF.mysql.host}:{CONF.mysql.port}/{CONF.mysql.database}?charset=utf8'
